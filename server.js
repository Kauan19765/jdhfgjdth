...
// Cole isto logo depois de `const app = express()` no seu server.js
// Substitua a string STREAM_SRC abaixo pela URL do seu proxy (OBRIGATÓRIO: manter o ';' no final)
const STREAM_SRC = 'https://jdhfgjdth.onrender.com/;';
